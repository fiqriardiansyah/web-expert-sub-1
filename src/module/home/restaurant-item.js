  ...
  render() {
    this.innerHTML = `
        <a href="#${RESTAURANT}/${this.restaurant?.id}" class="restaurant-item focusable">
          <img class="restaurant-image" src="https://restaurant-api.dicoding.dev/images/small/${this.restaurant?.pictureId}" alt="${this.restaurant?.name}" onerror="this.onerror=null;this.src='/images/placeholder.png'"/>
          <div class="content">
